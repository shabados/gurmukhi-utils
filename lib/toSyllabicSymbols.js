...
// Otherwise map each character to a syllableIdentifiers, for further processing/analysis
const syllabicMapping = Object.entries( {
  [ syllableIdentifiers.oneUnitSyllable ]: oneUnitSyllables,
  [ syllableIdentifiers.twoUnitSyllable ]: twoUnitSyllables,
  [ syllableIdentifiers.baseCharacter ]: baseCharacters,
  [ syllableIdentifiers.deeraghModifier ]: deeraghModifiers,
...
const toSyllabicSymbols = ( text ) => toUnicode( text ) // Sanitize input
  ...
  .replace( / +/g, ( v ) => v.slice( 0, 1 ) ) // e.g. 'ਹਫ਼ਤੇ ਵਿਚ 7 ਦਿਨ' last 2 words will have 2 spc
