 ...
 * @example <caption>Unicode first letters with no pair bindi/nukta</caption>
 ...
 * @example <caption>ASCII first letters with no pair bindi/nukta</caption>
 * firstLetters('iZir&qym sMdUk* drIXw AmIk* ]', false) // => Zsda
 */
const firstLetters = ( line, stripNukta = true ) => combinedExclusions
