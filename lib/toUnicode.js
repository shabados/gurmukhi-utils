...
const replacements = [
  ...
  [ /([iMyY])([R®H§´ÍÏçœ˜†])/ug, '$2$1' ], // Switch around position of pair R, y etc sounds
  [ /([MyY])([uU])/ug, '$2$1' ], // Switch around lava/dulava/tipee with aunkar/dulankar
  [ /`([wWIoOyYR®H§´ÍÏçœ˜†uU])/ug, '$1$2`' ], // Place adhak at end when vowels are either side
  [ /´i([wWoO])/ug, 'i$1´' ], // Swap i with Kanna or Hora/Kanorra after ´
]
