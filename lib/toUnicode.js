...
const mappings = Object
  ...
  // Order so that multichar expressions are captured first
...
const replacements = [
  ...
  [ /([iMyY])([RH†çÎÍ˜´])/ug, '$2$1' ], // Switch around position of pair R, y etc sounds
  ...
  [ /´i([wWoOM])/ug, '´$1i' ], // Swap i with pair akhar after ´
]
