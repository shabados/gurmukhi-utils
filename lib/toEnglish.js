...
// Vishraam characters
const vishraams = require( './vishraams' )
...
const toEnglish = line => {
  ...
  const transliterated = replacements
    ...
    .map( ( letter, index, line ) => {
      ...
      if ( extraARules.every( fn => fn( mappedLetter, nextLetter, nextNextLetter, prevLetter ) ) ) { mappedLetter += 'a' }
