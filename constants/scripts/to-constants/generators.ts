...
export const javascriptGenerator: LanguageGenerator = (inputs) =>
  inputs.map(({ name, variables }) => ({
    path: `bindings/javascript/src/constants/${name}.ts`,
    content: `
...
export const pythonGenerator: LanguageGenerator = (inputs) => [
  ...inputs.map(({ name, variables }) => ({
    path: `bindings/python/gurmukhiutils/constants/${toUnderscore(name)}.py`,
    content: `
# This file is generated by the constants build script.
# Do not edit this file directly.
...
`,
  ...
  {
    path: 'bindings/python/gurmukhiutils/constants/__init__.py',
    content: `
# This file is generated by the constants build script.
# Do not edit this file directly.
`,
...
export const rubyGenerator: LanguageGenerator = (inputs) =>
  inputs.map(({ name, variables }) => ({
    path: `bindings/ruby/lib/constants/${toUnderscore(name)}.rb`,
    content: `
# This file is generated by the constants build script.
# Do not edit this file directly.
